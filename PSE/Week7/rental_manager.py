...
# When manager1 = RentalManager() is invoked a new instance is created
# When manager2 = RentalManager() is invoked it checks if there is no instance, 
# but as one instance has already being created manager2 will be using the smae instance
# and so both are the same object